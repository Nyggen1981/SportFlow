...
export default function CompetitionsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "DRAFT":
        return <span className="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-600 rounded-full">Kommende</span>
      case "SCHEDULED":
      ...
      <div className="min-h-screen bg-slate-50 flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <h1 className="text-xl font-bold text-gray-900 mb-2">Ingen konkurranser</h1>
            <p className="text-gray-500">Konkurranser er ikke tilgjengelig for øyeblikket.</p>
          </div>
        </main>
        <Footer />
      </div>
