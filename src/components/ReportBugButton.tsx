  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-40 flex items-center gap-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 text-white text-sm rounded-full shadow-lg transition-all hover:scale-105"
